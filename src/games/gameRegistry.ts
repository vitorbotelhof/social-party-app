...
export const JOGOS: ReadonlyArray<DefinicaoJogo> = [
  ...
  },
  {
    ...
    slogan: 'duas zonas. uma ameaça. ninguém sabe de nada.',
    descricao:
      'Um jogo de dedução social e negociação. Os jogadores estão divididos em duas zonas e, a cada rodada, trocam um membro. A Ameaça tenta se aproximar do Alvo — o Resgate tenta mantê-los separados. Ninguém sabe quem é quem.',
    cover: require('../../assets/games/operacao resgate/cover.png'),
    banner: require('../../assets/games/operacao resgate/banner.png'),
    minJogadores: 4,
    maxJogadores: 12,
    tempoMedio: '15-35 min',
    intensidade: 3,
    disponivel: true,
    supportsLocal: true,
    supportsRealtime: false,
    categoriasPrincipais: ['blefe_deducao'],
    tagsSociais: ['deducao', 'blefe', 'segredo', 'paranoia'],
    contextos: ['pra_descobrir_o_grupo', 'pra_subir_energia', 'pra_comecar'],
    descoberta: {
      mecanicaPrincipal: 'deducao',
      intencaoSocial: 'competir',
      ritmo: 3,
    ...
    socialTags: ['segredo', 'blefe', 'deducao'],
    categorias: ['tensao_misterio'],
    destaque: false,
    ordemNaCategoria: 7,
    instrucoes: {
      objetivo:
        'O Resgate vence se o Alvo e a Ameaça estiverem em zonas separadas no final. A Sabotagem vence se conseguir colocar os dois na mesma zona.',
      passos: [
        'Cada jogador recebe uma carta privada com seu papel e não deve revelar.',
        'Os jogadores são divididos em Zona A e Zona B.',
        'A cada rodada, os líderes de cada zona negociam entre si e decidem quem enviar para a outra zona.',
        'Após todas as rodadas, o resultado é revelado: Alvo e Ameaça na mesma zona — Sabotagem vence. Zonas separadas — Resgate vence.',
      ],
      dicas: [
        'Observe quem insiste em certas trocas — pode ser a Ameaça se movendo estrategicamente.',
        'O Alvo não sabe quem é a Ameaça. Seja cético com qualquer um que tente acompanhar você.',
        'O Informante tem uma informação real — mas pode estar mentindo sobre ela.',
      ],
    },
  },
  {
